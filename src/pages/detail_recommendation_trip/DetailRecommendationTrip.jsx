        ...
        <Row className="mt-3">
          <Col lg="4">
            ...
            <div className="posted">
              <Image src={"https://cdn-icons-png.flaticon.com/512/147/147142.png"} className="img-fluid rounded-circle shadow-4 image-profile" alt="..." />
            ...
            {({ handleSubmit, handleChange }) => (
              <Form>
                <div className="form-group">
                  ...
                  <input type="text" className="form-control" id="tripname" name="trip_name" onChange={handleChange} required />
                </div>
                <div className="form-group mt-3">
                  <label for="startdate">Start Date</label>
                  <input type="date" className="form-control" id="startdate" name="start_date" placeholder="Start Date" onChange={handleChange} required />
                </div>
                <div className="form-group mt-3">
                  <label for="enddate">End Date</label>
                  <input type="date" className="form-control" id="enddate" name="end_date" placeholder="End Date" onChange={handleChange} required />
                </div>
                <div className="form-group mt-3">
                  <label for="maxmember">Max Member</label>
                  <input type="number" className="form-control" id="maxmember" name="max_member" onChange={handleChange} required />
                </div>
                <div className="btn-create">
                  <button onClick={handleSubmit} type="submit" className="btn btn-primary w-100 mt-3">
                    Create Trip
                  </button>
                </div>
              </Form>
