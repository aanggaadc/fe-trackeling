                                ...
                                <Form id="form-trip">
                                    ...
                                    <div className="form-group mt-3">
                                        <input type='file'
                                            ...
                                            required />
                                        <label for='file'> <FaUpload size={22} /> Edit Trip Image </label> <br /> <br />
                                        <img
                                            src={
                                                image
                                                    ? URL.createObjectURL(image)
                                                    : `${API_URL}/${data.trip_image}`
                                            }
                                            alt="trip image"
                                    ...
                                    <div className="form-group mt-3">
                                        ...
                                        <select id="tripstatus" value={values.trip_status} name="trip_status" onChange={handleChange} >
